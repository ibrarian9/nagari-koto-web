        ...
        <div class="text-center mb-16 relative">
            ...
            @if ($profile->logo)
                <img src="{{ Storage::url($profile->logo) }}" alt="{{ $profile->name }}"
                    class="h-20 w-20 mx-auto mb-4 object-contain rounded-2xl shadow-lg shadow-desa-500/10 ring-4 ring-white">
            @else
                <div
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div class="lg:col-span-8 space-y-8">
                ...
                @if ($profile->description)
                    <div class="card p-6 sm:p-8 bg-white border border-gray-150/60">
                        <h2 class="text-lg font-extrabold text-gray-900 flex items-center gap-2 mb-4">
                            <span class="material-symbols-outlined text-desa-600">description</span>
                ...
                @if ($profile->sejarah)
                    <div class="card p-6 sm:p-8 bg-white border border-gray-150/60">
                        <h2 class="text-lg font-extrabold text-gray-900 flex items-center gap-2 mb-4">
                            <span class="material-symbols-outlined text-desa-600">history_edu</span>
                            Sejarah BUMNag
                        </h2>
                        <div class="prose prose-sm max-w-none text-gray-600 leading-relaxed">
                ...
                @if ($profile->visi || $profile->misi)
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        @if ($profile->visi)
                            <div class="card p-6 bg-gradient-to-br from-desa-50/50 to-white border border-desa-100/60">
                                <div class="flex items-center gap-2 mb-3">
                                    <div class="h-8 w-8 rounded-lg bg-desa-100 flex items-center justify-center text-desa-600">
                ...
                @if (!empty($profile->unit_usaha))
                    <div>
                        <div class="flex items-center gap-3 border-b border-gray-150 pb-3 mb-6">
                            <div class="h-9 w-9 rounded-xl bg-desa-50 flex items-center justify-center text-desa-600">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            @foreach ($profile->unit_usaha as $i => $unit)
                                <div class="card p-5 bg-white border border-gray-150/60 hover:border-desa-300 hover:shadow-lg transition-all duration-300 group">
                                    <div class="flex items-start gap-3">
                                        <div class="h-10 w-10 rounded-xl bg-desa-50 flex items-center justify-center text-desa-600 flex-shrink-0 group-hover:bg-desa-100 transition-colors">
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="card p-5 bg-gray-50/50 border border-gray-150/60">
                    <h3 class="font-bold text-gray-900 flex items-center gap-2 text-sm mb-4">
                        <span class="material-symbols-outlined text-desa-600 text-lg">contact_phone</span>
                        Kontak BUMNag
                    </h3>
                    <div class="space-y-3">
                        @if ($profile->alamat)
                ...
                <div class="card p-6 bg-gradient-to-br from-desa-600 to-desa-800 text-white relative overflow-hidden border-none shadow-md">
                    ...
                    <a href="{{ route('bumnag.program-kerja') }}" wire:navigate
                        class="w-full inline-flex items-center justify-center gap-1.5 px-4 py-2.5 bg-desa-500 hover:bg-desa-600 text-white text-xs font-bold rounded-xl transition-all shadow-md">
