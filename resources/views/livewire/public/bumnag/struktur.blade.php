<div>
    <section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        @if ($pembina->count() || $pengurus->count() || $pengawas->count())
            ...
            {{-- 1. PIMPINAN & PENGURUS BUMNAG (UTAMA DI PALING ATAS) --}}
            @if ($pengurus->count())
                @php
                ...
                @if ($staff->count())
                    <div class="max-w-5xl mx-auto mb-16 space-y-6">
                        <div class="flex items-center gap-3 border-b border-gray-150 pb-3">
                            ...
                            <div>
                                <h2 class="text-lg font-extrabold text-gray-900 tracking-tight">Pengurus & Pelaksana BUMNag</h2>
            ...
            {{-- Divider --}}
            <div class="flex items-center justify-center gap-4 max-w-4xl mx-auto mb-14">
                <div class="h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent flex-1"></div>
                <div class="h-2 w-2 rounded-full bg-blue-400"></div>
                <div class="h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent flex-1"></div>
            </div>

            {{-- 2. PEMBINA / PENASEHAT (DI BEKANG / DI BAWAH PIMPINAN) --}}
            @if ($pembina->count())
                <div class="max-w-5xl mx-auto mb-16 space-y-6">
                    <div class="flex items-center gap-3 border-b border-gray-150 pb-3">
            ...
            {{-- 3. BADAN PENGAWAS / KOMISARIS (DI BAWAH) --}}
            @if ($pengawas->count())
                <div class="max-w-5xl mx-auto space-y-6">
                    <div class="flex items-center gap-3 border-b border-gray-150 pb-3">
                        ...
                        <div>
                            <h2 class="text-lg font-extrabold text-gray-900 tracking-tight">Badan Pengawas / Komisaris</h2>
                            <p class="text-xs text-gray-400">Mengawasi kinerja pengelola dan akuntabilitas keuangan BUMNag</p>
                        </div>
                    </div>
