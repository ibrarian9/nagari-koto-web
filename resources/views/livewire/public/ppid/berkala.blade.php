<div>
    <section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="mb-10 text-center md:text-left md:flex md:items-center md:justify-between border-b border-gray-150 pb-8">
            <div>
                <div class="inline-flex items-center gap-2 rounded-full bg-desa-50 border border-desa-100 px-3 py-1 text-xs text-desa-700 font-semibold mb-3">
                    <span class="material-symbols-outlined text-sm">schedule</span>
                    Informasi Publik Berkala
                </div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Informasi Berkala</h1>
                <p class="text-sm text-gray-500 mt-1">Dokumen yang dipublikasikan secara berkala sesuai ketentuan</p>
            </div>
