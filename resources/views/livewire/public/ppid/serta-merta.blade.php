    ...
    <section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="mb-10 text-center md:text-left md:flex md:items-center md:justify-between border-b border-gray-150 pb-8">
            <div>
                ...
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Informasi Serta Merta</h1>
                <p class="text-sm text-gray-500 mt-1">Pengumuman darurat yang harus diketahui masyarakat segera</p>
            </div>
