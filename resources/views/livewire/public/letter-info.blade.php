    ...
    <section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="card p-6 mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                @foreach ([['step' => '1', 'icon' => 'login', 'title' => 'Login Akun', 'desc' => 'Masuk ke akun Anda atau daftar terlebih dahulu sebagai warga.'], ['step' => '2', 'icon' => 'edit_note', 'title' => 'Isi Formulir', 'desc' => 'Pilih jenis surat dan lengkapi data yang diperlukan.'], ['step' => '3', 'icon' => 'hourglass_top', 'title' => 'Proses Verifikasi', 'desc' => 'Petugas akan memverifikasi dan memproses permohonan Anda.'], ['step' => '4', 'icon' => 'task_alt', 'title' => 'Surat Siap', 'desc' => 'Ambil surat yang sudah jadi di Kantor Nagari.']] as $step)
                    <div class="relative flex flex-col items-center text-center">
                        <div
                            class="h-12 w-12 rounded-full bg-desa-500 text-white flex items-center justify-center font-bold text-lg mb-3 shadow-md shadow-desa-500/20">
                            {{ $step['step'] }}
                        </div>
                        ...
                        @if (!$loop->last)
                            <div
                                class="hidden lg:block absolute top-6 left-[calc(50%+28px)] w-[calc(100%-56px)] h-px bg-gray-200">
                            </div>
                        @endif
                    </div>
                @endforeach
        ...
        <div class="rounded-xl bg-amber-50 border border-amber-200 p-5 flex items-start gap-4 mb-8">
            ...
            <div class="text-sm text-amber-800">
                ...
                <p>Jika mengalami kendala dalam pengajuan surat, silakan hubungi <strong>Kantor Wali Nagari</strong> di
                    jam kerja (Senin–Jumat, 08.00–16.00 WIB) atau datang langsung ke Kantor Nagari.</p>
            </div>
        </div>
            ...
            @auth
                ...
                @else
                    <div class="card p-8 max-w-md mx-auto text-center">
                        ...
                        <p class="text-sm text-gray-400">Fitur pengajuan surat hanya tersedia untuk akun warga terdaftar.
                            Anda login sebagai <strong>{{ auth()->user()->role }}</strong>.</p>
                    </div>
                @endif
            @else
                <div class="card p-8 max-w-md mx-auto text-center">
