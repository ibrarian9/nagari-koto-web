<div>
    <section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div class="text-center mb-12">
            <div data-aos="zoom-in" class="inline-flex items-center justify-center h-16 w-16 rounded-2xl bg-gradient-to-br from-desa-500 to-desa-700 mb-4 shadow-lg shadow-desa-500/20">
            ...
            <p data-aos="fade-up" data-aos-delay="200" class="section-subtitle">Perangkat desa yang melayani masyarakat</p>
        </div>
        ...
        @if($members->count())
            ...
            @if($kaur->count())
                <div class="relative mb-4">
                    ...
                    <div class="hidden md:block absolute top-0 left-1/2 -translate-x-1/2 h-px bg-gray-200" style="width: {{ min($kaur->count() * 220, 600) }}px"></div>
            ...
            @if($kasi->count())
                <div class="relative mb-4">
                    <div class="hidden md:block absolute top-0 left-1/2 -translate-x-1/2 h-px bg-gray-200" style="width: {{ min($kasi->count() * 220, 800) }}px"></div>
            ...
            @if($jorong->count())
                ...
                <div class="mb-4">
                    <p class="text-center text-xs font-semibold text-gray-400 uppercase tracking-widest mb-4">Kepala Jorong</p>
