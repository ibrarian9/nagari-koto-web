    ...
    <div class="card p-6 mb-6">
        ...
        <form wire:submit="save" class="space-y-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div><label class="form-label">File Dokumen {{ $editingId ? '(kosongkan jika tidak ganti)' : '' }}</label><input type="file" wire:model="file" class="form-input w-full text-sm" accept=".pdf,.doc,.docx,.xls,.xlsx">@error('file')<p class="form-error">{{ $message }}</p>@enderror</div>
            </div>
